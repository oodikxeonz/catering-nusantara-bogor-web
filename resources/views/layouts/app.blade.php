...
<body class="bg-cnb-cream text-cnb-black">

    <nav class="sticky top-0 z-50 bg-cnb-black/95 backdrop-blur text-cnb-cream shadow-lg">
        <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <a href="https://wa.me/6280000000000" target="_blank"
               class="bg-cnb-gold text-cnb-black text-sm font-semibold px-4 py-2 rounded-full hover:bg-cnb-gold-light transition">
                Pesan Sekarang
            </a>
        </div>
    </nav>
    ...
    <footer class="bg-cnb-black text-cnb-cream mt-20">
        <div class="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8">
            <div>
                <h3 class="font-serif text-lg font-bold mb-2">
                    Catering <span class="text-cnb-gold">Nusantara</span>
                </h3>
                <p class="text-sm text-gray-300">Catering nasi box, tumpeng, dan snack box khas Nusantara untuk setiap momen spesial Anda di Bogor.</p>
            </div>
            <div>
                <h4 class="font-semibold mb-2 text-cnb-gold">Navigasi</h4>
                <ul class="text-sm space-y-1 text-gray-300">
                    <li><a href="{{ route('menu.index') }}" class="hover:text-cnb-gold">Menu</a></li>
                    <li><a href="{{ route('gallery') }}" class="hover:text-cnb-gold">Galeri</a></li>
                    <li><a href="{{ route('about') }}" class="hover:text-cnb-gold">Tentang Kami</a></li>
                </ul>
            </div>
            <div>
                <h4 class="font-semibold mb-2 text-cnb-gold">Kontak</h4>
                <p class="text-sm text-gray-300">WhatsApp: 0800-0000-0000</p>
                <p class="text-sm text-gray-300">Area: Bogor & Sekitarnya</p>
            </div>
        </div>
    ...
    <a href="https://wa.me/6280000000000" target="_blank"
       class="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-xl z-50 transition">
