...
@section('content')
    ...
    <section class="relative min-h-[60vh] flex items-center overflow-hidden bg-cnb-wood-dark">
        <div class="absolute inset-0">
            ...
            <div class="absolute inset-0 bg-linear-to-r from-cnb-wood-dark/95 via-cnb-wood-dark/80 to-cnb-wood-dark/60"></div>
        </div>
        ...
        <div class="container mx-auto px-6 relative z-10 py-20">
            <div class="max-w-4xl">
                <div class="flex items-center gap-4 mb-6">
                    <span class="text-cnb-gold font-sans text-xs md:text-sm tracking-[0.3em] uppercase font-semibold">LANGKAH MUDAH & CEPAT</span>
    ...
    <section class="py-24 bg-cnb-cream relative">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <span class="text-cnb-gold font-sans text-xs md:text-sm tracking-[0.3em] uppercase font-semibold">ALUR PEMESANAN</span>
                <h2 class="font-serif text-3xl md:text-4xl text-cnb-wood-dark mt-3 mb-4 font-bold">5 Langkah <span class="text-cnb-gold">Pesan Catering</span></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                @foreach($steps as $s)
                    <div class="group p-8 bg-white rounded-3xl shadow-md border border-cnb-wood-dark/5 hover:border-cnb-gold/40 hover:shadow-2xl transition-all duration-500 ease-out hover:-translate-y-3 flex flex-col justify-between">
                        <div>
                            <div class="flex items-center justify-between mb-6">
                                <div class="w-16 h-16 rounded-2xl bg-cnb-gold/10 border border-cnb-gold/30 flex items-center justify-center group-hover:bg-cnb-gold transition-all duration-500 shadow-inner">
                                    <svg class="w-8 h-8 text-cnb-gold group-hover:text-cnb-wood-dark transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="{{ $s['icon'] }}" /></svg>
                                </div>
                                <span class="font-serif text-3xl font-bold text-cnb-gold/40 group-hover:text-cnb-gold transition-colors duration-300">{{ $s['no'] }}</span>
                            </div>
                            <h3 class="font-serif text-xl font-bold text-cnb-wood-dark mb-3 group-hover:text-cnb-gold transition-colors duration-300">{{ $s['title'] }}</h3>
                            <p class="text-cnb-gray font-sans text-sm leading-relaxed">{{ $s['desc'] }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section class="py-24 bg-cnb-leaf-dark relative overflow-hidden batik-pattern-diagonal">
        <div class="container mx-auto px-6 relative">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <span class="text-cnb-gold font-sans text-xs md:text-sm tracking-[0.3em] uppercase font-semibold">INFO PENTING</span>
                <h2 class="font-serif text-3xl md:text-4xl text-white mt-3 mb-4 font-bold">Ketentuan <span class="text-cnb-gold">Pemesanan</span></h2>
                <div class="w-16 h-0.5 bg-cnb-gold mx-auto"></div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                <div class="bg-white/5 backdrop-blur-md border border-cnb-gold/20 rounded-2xl p-8 hover:border-cnb-gold/50 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <ul class="space-y-3 text-white/80 font-sans text-sm leading-relaxed">
                        <li>• Pesanan <strong class="text-white">s.d. 20 pax</strong>: Bisa dipesan H-1 / Same Day (tergantung slot).</li>
                        <li>• Pesanan <strong class="text-white">20 - 100 pax</strong>: Pemesanan minimal H-2 acara.</li>
                        <li>• Pesanan <strong class="text-white">> 100 pax</strong>: Pemesanan disarankan H-3 sampai H-5 acara.</li>
                    </ul>
                </div>
    ...
    <section class="relative py-24 bg-cnb-wood-dark overflow-hidden">
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="font-serif text-3xl md:text-5xl text-white font-bold mb-4 leading-tight">Siap Melakukan <span class="text-cnb-gold">Pemesanan?</span></h2>
                <p class="text-white/70 font-sans text-base md:text-lg max-w-2xl mx-auto mb-10 font-light leading-relaxed">Hubungi admin kami sekarang untuk mendapatkan penawaran harga terbaik untuk acara Anda.</p>
